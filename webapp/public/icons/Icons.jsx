...
export const ArrowUp = () => {return(<PiCaretUpBold className='icon-faded' size={22}/>);}

import { PiMagnifyingGlassBold } from "react-icons/pi";
export const SearchIcon = () => {return(<PiMagnifyingGlassBold className='icon-faded' size={64}/>);}

import { PiMagnifyingGlassMinusBold } from "react-icons/pi";
export const NoResultIcon = () => {return(<PiMagnifyingGlassMinusBold className='icon-faded' size={64}/>);}
